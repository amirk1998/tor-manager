...
> **چرا Tor؟**
> Tor رایگان است، نیازی به پرداخت ماهانه ندارد، توسط یک سازمان غیرانتفاعی مستقل نگهداری می‌شود، و پورت SOCKS5 آن با تقریباً هر اپلیکیشنی — از تلگرام گرفته تا مرورگرها و ابزارهای CLI — سازگار است.
...
│       ├── styles.go            سیستم طراحی مرکزی (پالت رنگ، کامپوننت‌ها)
